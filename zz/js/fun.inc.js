...
$(".navsearch_input>input").focus(function () {
    if ($(this).val() == "请输入关键字") {
        $(this).val("").css("color", "#000");
    }
})
$(".navsearch_input>input").blur(function () {
    if ($(this).val() == "") {
        $(this).val("请输入关键字").css("color", "#787878")
    }
})
...
$("nav li[class!='line']").hover(
    function () {
        ...
        if (dlkd <= likd) {
            ...
            var lfdkx = rckd - dlkd;
            if (lfdkx < 0) {
                $(this).find('dl').css("left", lfdkx + 'px');
            }
        }
        $(this).addClass('hover');
        $(this).find('dl').show();
...
if (module == 10001) {
    ...
    //首页侧栏
    $("#productNav dt").mouseover(function () {
        $(this).next("dd").show();
    });
    $("#productNav dd").mouseover(function () {
        $(this).show();
    });
    $("#productNav dt").mouseout(function () {
        $(this).next("dd").hide();
    });
    $("#productNav dd").mouseout(function () {
        $(this).hide();
    });
